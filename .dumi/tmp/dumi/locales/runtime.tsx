...
import { useIsomorphicLayoutEffect } from '/Users/huangyuming/Desktop/createProjects/AI-code/node_modules/.pnpm/dumi@2.4.21_@babel+core@7.27.1_@swc+helpers@0.5.2_@types+node@20.17.46_@types+react@18._2750791a49e403c0ffe0268450ddaef5/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/ai-code-project/hooks/edit/main/{filename}";

    localeMessages['$internal.api.sourceLink'] = "https://github.com/ai-code-project/hooks/tree/main/{fileName}#L{line}";
